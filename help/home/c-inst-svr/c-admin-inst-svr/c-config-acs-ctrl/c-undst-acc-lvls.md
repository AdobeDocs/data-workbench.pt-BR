...
<table id="table_8E6FDD741BF24E2DAD96A2919FAE6C7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>/Perfis/ </p> <p>/Status/ </p> <p>/Software/ </p> <p>/Addresses/ </p> <p>/Usuários/$ </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>/Components for Processing Servers/ </p> <p>/Addresses/ </p> <p>/Perfis/ </p> <p>/Pesquisas/ </p> <p>/Controle de acesso/ </p> <p>/Bin/ </p> <p>/Logs/ </p> </td> 
...
1. No [!DNL Server Files Manager], clique **[!UICONTROL Access Control]** para visualização do conteúdo. O [!DNL Access Control.cfg] arquivo está localizado dentro deste diretório.
...
1. Na [!DNL Access Control.cfg] janela, clique **[!UICONTROL Access Control Groups]** para visualização do conteúdo.

   ![](assets/access_ctrl_cfg.png)

1. Para adicionar um novo grupo de controles de acesso:
   ...
   1. Clique com o botão direito do mouse **[!UICONTROL Members]** e clique em **[!UICONTROL Add new]** > **[!UICONTROL Member]**.
      ...
      Os membros dos grupos padrão não são predefinidos. Por padrão, o acesso do Administrador é concedido ao 127.0.0.1 (host local) e o acesso [!DNL Sensor] é concedido ao IP:*. Todos os outros membros do grupo de controles de acesso devem ser definidos.

   1. Complete os parâmetros.

1. Para adicionar novos membros a um grupo de controles de acesso existente:

   1. Clique com o botão direito do mouse **[!UICONTROL Members]** no grupo de controles de acesso apropriado e clique em **[!UICONTROL Add new]** > **[!UICONTROL Member]**.

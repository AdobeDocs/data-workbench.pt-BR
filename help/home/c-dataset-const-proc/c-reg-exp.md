---
description: Expressões regulares são usadas em todos os campos de pesquisa da análise de big data, incluindo os painéis da entidade de consulta.
solution: Analytics
...
| Padrão | Esta é a terminologia abreviada para a expressão regular. Em essência, uma expressão regular é um padrão que você está tentando corresponder à string de destino. |
| String de destino | Esse termo se refere à string que estamos pesquisando para localizar o padrão desejado. |
...
|---|---|
| . (ponto) | Corresponde a um único caractere, por exemplo: corresponde `re:x.z` a &quot;xyz&quot; ou &quot;xxz&quot;. |
| * (estrela) | Corresponde a um ou mais caracteres, por exemplo: corresponde `re:Z*` a &quot;ZZZ&quot;. |
...
<table id="table_18B86955EC3748079E7C176273ADE92B"> 
 <thead> 
  <tr> 
   ...
   <th colname="col2" class="entry"> O processador de expressões regulares... </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> Tubo (|) </td> 
   <td colname="col2"> Corresponder uma de duas opções a uma determinada string de destino. Por exemplo, b|nat corresponde a bat ou nat. </td> 
  </tr> 
 </tbody> 
</table>
...
|---|---|
| Circumflex ou Caret (`^`) | Corresponder ao início da string. Por exemplo, ^`[Tt]`ele corresponderia à string de destino &quot;O início&quot;, mas não corresponderia a &quot;Este é o início&quot;. |
...
<table id="table_6A14333D6C264A48ADF1EBBAF687CADD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Corresponder ao caractere de processo ou intervalo exatamente n vezes. O seguinte padrão corresponde aos números de telefone dos Estados Unidos: [0-9]{3}-[0-9]{3}-[0-9]{4}. </p> <p> Embora não seja um padrão ideal, ele determina se a string de destino está no formato correto. </p> </td> 
  </tr> 
  <tr> 

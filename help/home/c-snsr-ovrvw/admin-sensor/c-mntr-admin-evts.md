...
<table id="table_F8835AC0AD8F43E2B4494D8D35EBC0FD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> Informações do sensor 1012: A fila de discos da Adobe está #% cheia </td> 
  ...
  <tr> 
   <td colname="col1"> Erro de sensor 3018: Não é possível analisar listas de filtros de conteúdo. Verificar arquivo de configuração txlogd </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> O programa provavelmente foi encerrado por um sinal externo. Se a fonte desse sinal não puder ser determinada, entre em contato com o Adobe ClientCare. </td> 
  </tr> 
  <tr> 

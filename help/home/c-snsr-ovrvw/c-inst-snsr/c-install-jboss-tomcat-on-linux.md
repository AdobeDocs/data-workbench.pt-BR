---
description: Instruções detalhadas para instalar e configurar o Sensor para implementações J2EE em execução no RedHat Linux 7.x ou posterior, Sun Solaris SPARC 2.6 ou posterior ou Sun Solaris x86 9 ou posterior.
title: JBoss, Tomcat e WebLogic Servers no RedHat Linux ou Sun Solaris
...
# JBoss, Tomcat e WebLogic Servers no RedHat Linux ou Sun Solaris{#jboss-tomcat-and-weblogic-servers-on-redhat-linux-or-sun-solaris}

{{eol}}

Instruções detalhadas para instalar e configurar o Sensor para implementações J2EE em execução no RedHat Linux 7.x ou posterior, Sun Solaris SPARC 2.6 ou posterior ou Sun Solaris x86 9 ou posterior.
